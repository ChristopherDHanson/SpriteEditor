...
public:
    ...
    void retranslateUi(QMainWindow *SpriteEditorWindow)
    {
        ...
        pushButton->setText(QApplication::translate("SpriteEditorWindow", "PushButton", nullptr));
